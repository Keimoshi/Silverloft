...
import type { AppConfig, ChatAttachment, ChatCommentAttachment, ChatMessage, Conversation, PreviewComment, ProjectFile, SkillSummary } from '../types';
      ...
      {tab === 'chat' ? (
        <>
          ...
          <ChatComposer
            ...
            onImageTaskStarted={onImageTaskStarted}
            skills={skills}
