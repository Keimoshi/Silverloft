...
interface Props {
  ...
  mediaProviderStatus?: Record<string, MediaProviderStatus>;
  loading?: boolean;
}
      ...
      <div className="newproj-body">
        ...
        {tab === 'image' ? (
          <MediaProjectOptions
            ...
            mediaProviderStatus={mediaProviderStatus}
    ...
    return (
      <div className="newproj-media-options">
        <MediaModelCards
          ...
          mediaProviderStatus={props.mediaProviderStatus}
...
function MediaModelCards({
  ...
  for (const model of models) {
    ...
    const status = mediaProviderStatus?.[providerId];
    const configured =
      provider?.credentialsRequired === false || Boolean(status?.configured);
