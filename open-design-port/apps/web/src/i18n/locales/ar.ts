...
export const ar: Dict = {
  ...
  'settings.subtitle': 'اختر طريقة التشغيل والنموذج الافتراضي. تُحفظ الإعدادات في هذا المتصفح فقط.',
  ...
  'settings.modeApi': 'النماذج عبر الإنترنت',
  'settings.modeApiMeta': 'عبر الإنترنت',
  ...
  'settings.apiSection': 'النماذج عبر الإنترنت',
  'settings.quickFillProvider': 'تعبئة سريعة',
  'settings.customProvider': 'مخصص',
  'settings.apiKey': 'بيانات الاعتماد',
  ...
  'settings.suggestedModelsHint':
    'هذه نماذج مقترحة. قد تختلف القائمة المدعومة فعليًا.',
  'settings.baseUrl': 'نقطة النهاية',
  'settings.baseUrlInvalid': 'أدخل عنوانًا عامًا صالحًا http:// أو https://. يُسمح بـ localhost؛ يُمنع استخدام عناوين الشبكة الخاصة.',
  ...
  'settings.apiHint': 'تُمرَّر الطلبات عبر وكيل الخدمة المحلي إلى نقطة النهاية المحددة. تُحفظ بيانات الاعتماد في هذا المتصفح فقط.',
  ...
  'settings.anthropicApi': 'النماذج عبر الإنترنت',
  ...
  'settings.mediaProviderApiKey': 'بيانات الاعتماد',
  'settings.mediaProviderBaseUrl': 'نقطة النهاية',
  'settings.mediaProviderConfigured': 'تم التكوين',
  'settings.mediaProviderUnset': 'غير محدد',
  'settings.mediaProviderClear': 'مسح',
  'settings.mediaProviderPlaceholder': 'الصق بيانات الاعتماد',
  'settings.mediaProviderBaseUrlPlaceholder': 'تجاوز نقطة النهاية الافتراضية',
  'settings.about': 'حول',
  ...
  'newproj.voicePlaceholder': 'معرّف صوت اختياري',
  ...
  'avatar.anthropicApi': 'النماذج عبر الإنترنت',
  'avatar.useLocal': 'استخدام CLI محلي',
  'avatar.useApi': 'استخدام النماذج عبر الإنترنت',
  ...
  'agentPicker.byok': 'النماذج عبر الإنترنت',
