...
export const de: Dict = {
  ...
  'settings.subtitle': 'Wähle Ausführungsweise und Standardmodell. Einstellungen werden nur in diesem Browser gespeichert.',
  ...
  'settings.modeApi': 'Online-Modelle',
  ...
  'settings.apiSection': 'Online-Modelle',
  'settings.quickFillProvider': 'Schnelles Ausfüllen',
  'settings.customProvider': 'Benutzerdefiniert',
  'settings.apiKey': 'Zugangsdaten',
  ...
  'settings.suggestedModelsHint':
    'Dies sind empfohlene Modelle. Die tatsächlich unterstützte Liste kann abweichen.',
  'settings.baseUrl': 'Endpunkt',
  'settings.baseUrlInvalid': 'Gib eine gültige öffentliche http:// oder https:// Adresse ein. Localhost ist erlaubt; private Netzwerk-IPs sind blockiert.',
  ...
  'settings.apiHint': 'Anfragen werden über den lokalen Daemon-Proxy an den eingestellten Endpunkt geleitet. Zugangsdaten werden nur in diesem Browser gespeichert.',
  ...
  'settings.anthropicApi': 'Online-Modelle',
  ...
  'settings.mediaProviderApiKey': 'Zugangsdaten',
  'settings.mediaProviderBaseUrl': 'Endpunkt',
  'settings.mediaProviderConfigured': 'Konfiguriert',
  'settings.mediaProviderUnset': 'Nicht gesetzt',
  'settings.mediaProviderClear': 'Leeren',
  'settings.mediaProviderPlaceholder': 'Zugangsdaten einfügen',
  'settings.mediaProviderBaseUrlPlaceholder': 'Standard-Endpunkt überschreiben',
  'settings.about': 'Info',
  ...
  'newproj.voicePlaceholder': 'Optionale Stimm-ID',
  ...
  'avatar.anthropicApi': 'Online-Modelle',
  'avatar.useLocal': 'Lokale CLI verwenden',
  'avatar.useApi': 'Online-Modelle nutzen',
  ...
  'agentPicker.byok': 'Online-Modelle',
