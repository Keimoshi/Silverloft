...
export const en: Dict = {
  ...
  'settings.subtitle': 'Choose how Open Design runs and which model it should use. Settings are kept only in this browser.',
  ...
  'settings.modeApi': 'Online models',
  ...
  'settings.apiSection': 'Online models',
  'settings.quickFillProvider': 'Quick fill',
  ...
  'settings.suggestedModelsHint':
    'These are suggested models. The actually supported list may differ.',
  'settings.baseUrl': 'Endpoint',
  'settings.baseUrlInvalid': 'Enter a valid public http:// or https:// address. Localhost is allowed; private network IPs are blocked.',
  ...
  'settings.apiHint': 'Requests are routed through the local daemon proxy to the endpoint you set. Credentials are stored only in this browser.',
  ...
  'settings.anthropicApi': 'Online models',
  ...
  'settings.mediaProviderApiKey': 'Credential',
  ...
  'settings.mediaProviderPlaceholder': 'Paste credential',
  'settings.mediaProviderBaseUrlPlaceholder': 'Override default endpoint',
  ...
  'newproj.voicePlaceholder': 'Optional voice id',
  ...
  'avatar.anthropicApi': 'Online models',
  'avatar.useLocal': 'Use Local CLI',
  'avatar.useApi': 'Use online models',
  ...
  'agentPicker.byok': 'Online models',
