...
export const esES: Dict = {
  ...
  'settings.subtitle': 'Elige cómo se ejecuta y el modelo por defecto. La configuración se guarda solo en este navegador.',
  ...
  'settings.modeApi': 'Modelos en línea',
  'settings.modeApiMeta': 'En línea',
  ...
  'settings.apiSection': 'Modelos en línea',
  'settings.quickFillProvider': 'Relleno rápido',
  'settings.customProvider': 'Personalizado',
  'settings.apiKey': 'Credencial',
  ...
  'settings.suggestedModelsHint':
    'Estos son modelos sugeridos. La lista realmente compatible puede variar.',
  'settings.baseUrl': 'Endpoint',
  'settings.baseUrlInvalid': 'Introduce una dirección pública http:// o https:// válida. Localhost está permitido; las IPs de red privada se bloquean.',
  ...
  'settings.apiHint': 'Las llamadas pasan por el proxy del daemon local hasta el endpoint configurado. Las credenciales se guardan solo en este navegador.',
  ...
  'settings.anthropicApi': 'Modelos en línea',
  ...
  'settings.mediaProviderApiKey': 'Credencial',
  'settings.mediaProviderBaseUrl': 'Endpoint',
  ...
  'settings.mediaProviderPlaceholder': 'Pega la credencial',
  'settings.mediaProviderBaseUrlPlaceholder': 'Sobrescribir endpoint por defecto',
  ...
  'newproj.voicePlaceholder': 'Id de voz opcional',
  ...
  'avatar.anthropicApi': 'Modelos en línea',
  'avatar.useLocal': 'Usar CLI local',
  'avatar.useApi': 'Usar modelos en línea',
  ...
  'agentPicker.byok': 'Modelos en línea',
