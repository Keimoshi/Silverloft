...
export const fa: Dict = {
  ...
  'settings.subtitle': 'نحوه اجرا و مدل پیش‌فرض را انتخاب کنید. تنظیمات فقط در این مرورگر ذخیره می‌شود.',
  ...
  'settings.modeApi': 'مدل‌های آنلاین',
  'settings.modeApiMeta': 'آنلاین',
  ...
  'settings.apiSection': 'مدل‌های آنلاین',
  'settings.quickFillProvider': 'تکمیل سریع',
  'settings.customProvider': 'سفارشی',
  'settings.apiKey': 'اعتبارنامه',
  ...
  'settings.suggestedModelsHint':
    'این‌ها مدل‌های پیشنهادی هستند. فهرست واقعی پشتیبانی‌شده ممکن است متفاوت باشد.',
  'settings.baseUrl': 'نقطه پایانی',
  'settings.baseUrlInvalid': 'یک نشانی عمومی معتبر http:// یا https:// وارد کنید. localhost مجاز است؛ نشانی‌های شبکه خصوصی مسدود می‌شوند.',
  ...
  'settings.apiHint': 'درخواست‌ها از طریق پراکسی محلی به نقطه پایانی تنظیم‌شده ارسال می‌شوند. اعتبارنامه‌ها فقط در این مرورگر ذخیره می‌شوند.',
  ...
  'settings.anthropicApi': 'مدل‌های آنلاین',
  ...
  'settings.mediaProviderApiKey': 'اعتبارنامه',
  'settings.mediaProviderBaseUrl': 'نقطه پایانی',
  'settings.mediaProviderConfigured': 'پیکربندی شده',
  'settings.mediaProviderUnset': 'تنظیم نشده',
  'settings.mediaProviderClear': 'پاک کردن',
  'settings.mediaProviderPlaceholder': 'اعتبارنامه را بچسبانید',
  'settings.mediaProviderBaseUrlPlaceholder': 'بازنویسی نقطه پایانی پیش‌فرض',
  ...
  'newproj.voicePlaceholder': 'شناسه صدا (اختیاری)',
  ...
  'avatar.anthropicApi': 'مدل‌های آنلاین',
  'avatar.useLocal': 'استفاده از CLI محلی',
  'avatar.useApi': 'استفاده از مدل‌های آنلاین',
  ...
  'agentPicker.byok': 'مدل‌های آنلاین',
