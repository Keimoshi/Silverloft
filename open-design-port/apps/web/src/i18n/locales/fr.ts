...
export const fr: Dict = {
  ...
  'settings.subtitle': 'Choisissez le mode d\'exécution et le modèle par défaut. Les réglages sont enregistrés uniquement dans ce navigateur.',
  ...
  'settings.modeApi': 'Modèles en ligne',
  'settings.modeApiMeta': 'En ligne',
  ...
  'settings.apiSection': 'Modèles en ligne',
  'settings.quickFillProvider': 'Remplissage rapide',
  'settings.customProvider': 'Personnalisé',
  'settings.apiKey': 'Identifiant d\'accès',
  ...
  'settings.suggestedModelsHint':
    'Ce sont des modèles suggérés. La liste réellement prise en charge peut différer. D’autres modèles.',
  'settings.baseUrl': 'Point de terminaison',
  'settings.baseUrlInvalid': 'Saisissez une adresse publique http:// ou https:// valide. Localhost est autorisé ; les IP de réseau privé sont bloquées.',
  ...
  'settings.apiHint': 'Les requêtes passent par le proxy local jusqu\'au point de terminaison configuré. Les identifiants restent uniquement dans ce navigateur.',
  ...
  'settings.anthropicApi': 'Modèles en ligne',
  ...
  'settings.modelPlaceholder': 'Select a model',
  ...
  'settings.mediaProviderApiKey': 'Identifiant d\'accès',
  'settings.mediaProviderBaseUrl': 'Point de terminaison',
  'settings.mediaProviderConfigured': 'Configuré',
  'settings.mediaProviderUnset': 'Non défini',
  'settings.mediaProviderClear': 'Effacer',
  'settings.mediaProviderPlaceholder': 'Coller l\'identifiant',
  'settings.mediaProviderBaseUrlPlaceholder': 'Remplacer le point de terminaison par défaut',
  ...
  'newproj.voicePlaceholder': 'Identifiant de voix (optionnel)',
  ...
  'avatar.anthropicApi': 'Modèles en ligne',
  'avatar.useLocal': 'Utiliser le CLI local',
  'avatar.useApi': 'Utiliser les modèles en ligne',
  ...
  'agentPicker.byok': 'Modèles en ligne',
