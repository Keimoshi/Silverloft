...
export const hu: Dict = {
  ...
  'settings.subtitle': 'Válaszd ki a futtatás módját és az alapértelmezett modellt. A beállítások csak ebben a böngészőben tárolódnak.',
  ...
  'settings.modeApi': 'Online modellek',
  'settings.modeApiMeta': 'Online',
  ...
  'settings.apiSection': 'Online modellek',
  'settings.quickFillProvider': 'Gyors kitöltés',
  'settings.customProvider': 'Egyéni',
  'settings.apiKey': 'Hitelesítő adat',
  ...
  'settings.suggestedModelsHint':
    'Ezek javasolt modellek. A ténylegesen támogatott lista eltérhet.',
  'settings.baseUrl': 'Végpont',
  'settings.baseUrlInvalid': 'Adj meg érvényes nyilvános http:// vagy https:// címet. A localhost engedélyezett; a magánhálózati IP-k tiltottak.',
  ...
  'settings.apiHint': 'A kérések a helyi proxyn keresztül a beállított végponthoz mennek. A hitelesítő adatok csak ebben a böngészőben tárolódnak.',
  ...
  'settings.anthropicApi': 'Online modellek',
  ...
  'settings.mediaProviderApiKey': 'Hitelesítő adat',
  'settings.mediaProviderBaseUrl': 'Végpont',
  'settings.mediaProviderConfigured': 'Beállítva',
  'settings.mediaProviderUnset': 'Nincs beállítva',
  'settings.mediaProviderClear': 'Törlés',
  'settings.mediaProviderPlaceholder': 'Hitelesítő adat beillesztése',
  'settings.mediaProviderBaseUrlPlaceholder': 'Alapértelmezett végpont felülírása',
  ...
  'newproj.voicePlaceholder': 'Választható hang azonosító',
  ...
  'avatar.anthropicApi': 'Online modellek',
  'avatar.useLocal': 'Helyi CLI használata',
  'avatar.useApi': 'Online modellek használata',
  ...
  'agentPicker.byok': 'Online modellek',
