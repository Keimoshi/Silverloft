...
export const ja: Dict = {
  ...
  'settings.subtitle': '実行方式と既定のモデルを選択します。設定はこのブラウザにのみ保存されます。',
  ...
  'settings.modeApi': 'オンラインモデル',
  'settings.modeApiMeta': 'オンライン',
  ...
  'settings.apiSection': 'オンラインモデル',
  'settings.quickFillProvider': 'クイック入力',
  'settings.customProvider': 'カスタム',
  'settings.apiKey': '認証情報',
  ...
  'settings.suggestedModelsHint':
    'これらは推奨モデルです。実際に対応するモデルは異なる場合があります。',
  'settings.baseUrl': 'エンドポイント',
  'settings.baseUrlInvalid': '有効な公開 http:// または https:// アドレスを入力してください。localhost は許可されます。プライベート IP はブロックされます。',
  ...
  'settings.mediaProviderApiKey': '認証情報',
  'settings.mediaProviderBaseUrl': 'エンドポイント',
  'settings.mediaProviderConfigured': '設定済み',
  'settings.mediaProviderUnset': '未設定',
  'settings.mediaProviderClear': 'クリア',
  'settings.mediaProviderPlaceholder': '認証情報を貼り付け',
  'settings.mediaProviderBaseUrlPlaceholder': '既定のエンドポイントを上書き',
  ...
  'newproj.voicePlaceholder': '任意の音声 ID',
  ...
  'avatar.anthropicApi': 'オンラインモデル',
  'avatar.useLocal': 'ローカル CLI を使用',
  'avatar.useApi': 'オンラインモデルを使用',
