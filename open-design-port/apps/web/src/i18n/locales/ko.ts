...
export const ko: Dict = {
  ...
  'settings.subtitle': '실행 방식과 기본 모델을 선택하세요. 설정은 이 브라우저에만 저장됩니다.',
  ...
  'settings.modeApi': '온라인 모델',
  'settings.modeApiMeta': '온라인',
  ...
  'settings.apiSection': '온라인 모델',
  'settings.quickFillProvider': '빠른 입력',
  'settings.customProvider': '사용자 지정',
  'settings.apiKey': '자격 증명',
  ...
  'settings.suggestedModelsHint':
    '추천 모델입니다. 실제로 지원되는 모델은 다를 수 있습니다.',
  'settings.maxTokens': '최대 토큰 수 (선택 사항)',
  'settings.maxTokensHint':
    '응답 길이 상한입니다. 각 모델에는 기본값이 미리 조정되어 있으며(placeholder로 표시됨), 비워 두면 그 값을 사용하고 숫자를 입력하면 덮어씁니다.',
  'settings.baseUrl': '엔드포인트',
  'settings.baseUrlInvalid': '유효한 공개 http:// 또는 https:// 주소를 입력하세요. localhost 는 허용되며 사설 IP 는 차단됩니다.',
  ...
  'settings.mediaProviderApiKey': '자격 증명',
  'settings.mediaProviderBaseUrl': '엔드포인트',
  'settings.mediaProviderConfigured': '설정됨',
  'settings.mediaProviderUnset': '설정 안됨',
  'settings.mediaProviderClear': '지우기',
  'settings.mediaProviderPlaceholder': '자격 증명 붙여넣기',
  'settings.mediaProviderBaseUrlPlaceholder': '기본 엔드포인트 재정의',
  'settings.about': '정보',
  ...
  'newproj.voicePlaceholder': '선택 음성 ID',
  ...
  'avatar.anthropicApi': '온라인 모델',
  'avatar.useLocal': '로컬 CLI 사용',
  'avatar.useApi': '온라인 모델 사용',
