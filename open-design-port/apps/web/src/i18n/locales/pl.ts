...
export const pl: Dict = {
  ...
  'settings.subtitle': 'Wybierz tryb uruchamiania i model domyślny. Ustawienia są zapisywane tylko w tej przeglądarce.',
  ...
  'settings.modeApi': 'Modele online',
  ...
  'settings.apiSection': 'Modele online',
  'settings.quickFillProvider': 'Szybkie wypełnienie',
  'settings.customProvider': 'Niestandardowy',
  'settings.apiKey': 'Poświadczenie',
  ...
  'settings.suggestedModelsHint':
      'To sugerowane modele. Faktycznie obsługiwana lista może się różnić.',
  'settings.baseUrl': 'Punkt końcowy',
  'settings.baseUrlInvalid': 'Wprowadź prawidłowy publiczny adres http:// lub https://. Localhost jest dozwolony; prywatne adresy IP są blokowane.',
  ...
  'settings.apiHint': 'Żądania są kierowane przez lokalny proxy do skonfigurowanego punktu końcowego. Poświadczenia są przechowywane tylko w tej przeglądarce.',
  ...
  'settings.anthropicApi': 'Modele online',
  ...
  'settings.mediaProviderApiKey': 'Poświadczenie',
  'settings.mediaProviderBaseUrl': 'Punkt końcowy',
  ...
  'settings.mediaProviderPlaceholder': 'Wklej poświadczenie',
  'settings.mediaProviderBaseUrlPlaceholder': 'Zastąp domyślny punkt końcowy',
  ...
  'newproj.voicePlaceholder': 'Opcjonalny identyfikator głosu',
  ...
  'avatar.anthropicApi': 'Modele online',
  'avatar.useLocal': 'Użyj lokalnego CLI',
  'avatar.useApi': 'Użyj modeli online',
  ...
  'agentPicker.byok': 'Modele online',
