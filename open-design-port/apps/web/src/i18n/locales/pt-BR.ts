...
export const ptBR: Dict = {
  ...
  'settings.subtitle': 'Escolha como o app executa e o modelo padrão. As configurações ficam apenas neste navegador.',
  ...
  'settings.modeApi': 'Modelos online',
  ...
  'settings.apiSection': 'Modelos online',
  'settings.quickFillProvider': 'Preenchimento rápido',
  ...
  'settings.suggestedModelsHint':
    'Estes são modelos sugeridos. A lista realmente suportada pode variar.',
  'settings.baseUrl': 'Endpoint',
  'settings.baseUrlInvalid': 'Informe um endereço público http:// ou https:// válido. Localhost é permitido; IPs de rede privada são bloqueados.',
  ...
  'settings.apiHint': 'As chamadas passam pelo proxy do daemon local até o endpoint configurado. As credenciais ficam apenas neste navegador.',
  ...
  'settings.anthropicApi': 'Modelos online',
  ...
  'settings.mediaProviderPlaceholder': 'Cole a credencial',
  'settings.mediaProviderBaseUrlPlaceholder': 'Substituir endpoint padrão',
  ...
  'avatar.anthropicApi': 'Modelos online',
  'avatar.useLocal': 'Usar CLI local',
  'avatar.useApi': 'Usar modelos online',
  ...
  'agentPicker.byok': 'Modelos online',
