...
export const ru: Dict = {
  ...
  'settings.subtitle': 'Выберите способ запуска и модель по умолчанию. Настройки хранятся только в этом браузере.',
  ...
  'settings.modeApi': 'Онлайн-модели',
  ...
  'settings.apiSection': 'Онлайн-модели',
  'settings.quickFillProvider': 'Быстрая подстановка',
  'settings.customProvider': 'Пользовательский',
  'settings.apiKey': 'Учетные данные',
  ...
  'settings.suggestedModelsHint':
    'Это рекомендуемые модели. Фактический список может отличаться.',
  'settings.baseUrl': 'Адрес',
  'settings.baseUrlInvalid': 'Введите корректный публичный адрес http:// или https://. Localhost разрешен; IP-адреса частных сетей блокируются.',
  ...
  'settings.apiHint': 'Запросы идут через локальный прокси-демон на указанный адрес. Учетные данные хранятся только в этом браузере.',
  ...
  'settings.anthropicApi': 'Онлайн-модели',
  ...
  'settings.mediaProviderApiKey': 'Учетные данные',
  'settings.mediaProviderBaseUrl': 'Адрес',
  'settings.mediaProviderConfigured': 'Настроено',
  'settings.mediaProviderUnset': 'Не настроено',
  'settings.mediaProviderClear': 'Очистить',
  'settings.mediaProviderPlaceholder': 'Вставьте учетные данные',
  'settings.mediaProviderBaseUrlPlaceholder': 'Переопределить адрес по умолчанию',
  ...
  'newproj.voicePlaceholder': 'Необязательный идентификатор голоса',
  ...
  'avatar.anthropicApi': 'Онлайн-модели',
  'avatar.useLocal': 'Использовать локальный CLI',
  'avatar.useApi': 'Использовать онлайн-модели',
  ...
  'agentPicker.byok': 'Онлайн-модели',
