...
export const tr: Dict = {
  ...
  'settings.subtitle': 'Çalıştırma yöntemini ve varsayılan modeli seçin. Ayarlar yalnızca bu tarayıcıda saklanır.',
  ...
  'settings.modeApi': 'Çevrimiçi modeller',
  'settings.modeApiMeta': 'Çevrimiçi',
  ...
  'settings.apiSection': 'Çevrimiçi modeller',
  'settings.quickFillProvider': 'Hızlı doldurma',
  'settings.customProvider': 'Özel',
  'settings.apiKey': 'Kimlik bilgisi',
  ...
  'settings.suggestedModelsHint':
    'Bunlar önerilen modellerdir. Gerçekten desteklenen liste farklı olabilir.',
  'settings.baseUrl': 'Uç nokta',
  'settings.baseUrlInvalid': 'Geçerli bir genel http:// veya https:// adresi girin. localhost izinlidir; özel ağ IP’leri engellenir.',
  ...
  'settings.apiHint': 'İstekler yerel proxy üzerinden ayarlı uç noktaya gönderilir. Kimlik bilgileri yalnızca bu tarayıcıda saklanır.',
  ...
  'settings.anthropicApi': 'Çevrimiçi modeller',
  ...
  'settings.mediaProviderApiKey': 'Kimlik bilgisi',
  'settings.mediaProviderBaseUrl': 'Uç nokta',
  'settings.mediaProviderConfigured': 'Ayarlandı',
  'settings.mediaProviderUnset': 'Ayarlanmadı',
  'settings.mediaProviderClear': 'Temizle',
  'settings.mediaProviderPlaceholder': 'Kimlik bilgisini yapıştır',
  'settings.mediaProviderBaseUrlPlaceholder': 'Varsayılan uç noktayı geçersiz kıl',
  ...
  'newproj.voicePlaceholder': 'İsteğe bağlı ses kimliği',
  ...
  'avatar.anthropicApi': 'Çevrimiçi modeller',
  'avatar.useLocal': 'Yerel CLI’ı kullan',
  'avatar.useApi': 'Çevrimiçi modelleri kullan',
  ...
  'agentPicker.byok': 'Çevrimiçi modeller',
