...
export const uk: Dict = {
  ...
  'settings.subtitle': 'Виберіть спосіб запуску та модель за замовчуванням. Налаштування зберігаються лише в цьому браузері.',
  ...
  'settings.modeApi': 'Онлайн-моделі',
  'settings.modeApiMeta': 'Онлайн',
  ...
  'settings.apiSection': 'Онлайн-моделі',
  'settings.quickFillProvider': 'Швидке заповнення',
  'settings.customProvider': 'Користувацький',
  'settings.apiKey': 'Облікові дані',
  ...
  'settings.suggestedModelsHint':
    'Це рекомендовані моделі. Фактичний список може відрізнятися.',
  'settings.baseUrl': 'Адреса',
  'settings.baseUrlInvalid': 'Введіть коректну публічну адресу http:// або https://. Localhost дозволено; IP приватних мереж блокуються.',
  ...
  'settings.apiHint': 'Запити проходять через локальний проксі до налаштованої адреси. Облікові дані зберігаються лише в цьому браузері.',
  ...
  'settings.anthropicApi': 'Онлайн-моделі',
  ...
  'settings.mediaProviderApiKey': 'Облікові дані',
  'settings.mediaProviderBaseUrl': 'Адреса',
  ...
  'settings.mediaProviderPlaceholder': 'Вставте облікові дані',
  'settings.mediaProviderBaseUrlPlaceholder': 'Замінити адресу за замовчуванням',
  ...
  'newproj.voicePlaceholder': 'Необовʼязковий ідентифікатор голосу',
  ...
  'avatar.anthropicApi': 'Онлайн-моделі',
  'avatar.useLocal': 'Використовувати локальний CLI',
  'avatar.useApi': 'Використовувати онлайн-моделі',
  ...
  'agentPicker.byok': 'Онлайн-моделі',
