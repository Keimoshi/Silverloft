...
export const zhCN: Dict = {
  ...
  'settings.subtitle': '选择执行方式与默认模型，设置仅保存在当前浏览器中。',
  ...
  'settings.modeApi': '在线模型',
  'settings.modeApiMeta': '在线',
  ...
  'settings.apiSection': '在线模型',
  'settings.quickFillProvider': '快速填充',
  ...
  'settings.baseUrlInvalid': '请输入有效的公网 http:// 或 https:// 地址。允许 localhost；会阻止私有网络 IP。',
  ...
  'settings.modelPlaceholder': '请选择模型',
  ...
  'settings.mediaProviderApiKey': '凭证',
  'settings.mediaProviderBaseUrl': '服务地址',
  'settings.mediaProviderConfigured': '已配置',
  'settings.mediaProviderUnset': '未配置',
  'settings.mediaProviderClear': '清除',
  'settings.mediaProviderPlaceholder': '粘贴凭证',
  'settings.mediaProviderBaseUrlPlaceholder': '覆盖默认服务地址',
  'settings.about': '关于',
  ...
  'newproj.voicePlaceholder': '可选音色 id',
  ...
  'avatar.anthropicApi': '在线模型',
  'avatar.useLocal': '使用本机 CLI',
  'avatar.useApi': '使用在线模型',
