...
export const zhTW: Dict = {
  ...
  'settings.subtitle': '選擇執行方式與預設模型，設定僅儲存在目前瀏覽器中。',
  ...
  'settings.modeApi': '線上模型',
  'settings.modeApiMeta': '線上',
  ...
  'settings.apiSection': '線上模型',
  'settings.quickFillProvider': '快速填入',
  'settings.customProvider': '自訂',
  'settings.apiKey': '憑證',
  ...
  'settings.suggestedModelsHint':
    '這些是建議模型，實際支援的模型可能不同。',
  'settings.baseUrl': '服務位址',
  'settings.baseUrlInvalid': '請輸入有效的公網 http:// 或 https:// 位址。允許 localhost；會阻止私有網路 IP。',
  ...
  'settings.mediaProviderApiKey': '憑證',
  'settings.mediaProviderBaseUrl': '服務位址',
  'settings.mediaProviderConfigured': '已設定',
  'settings.mediaProviderUnset': '未設定',
  'settings.mediaProviderClear': '清除',
  'settings.mediaProviderPlaceholder': '貼上憑證',
  'settings.mediaProviderBaseUrlPlaceholder': '覆蓋預設服務位址',
  'settings.about': '關於',
  ...
  'newproj.voicePlaceholder': '可選音色 id',
  ...
  'avatar.anthropicApi': '線上模型',
  'avatar.useLocal': '使用本機 CLI',
  'avatar.useApi': '使用線上模型',
